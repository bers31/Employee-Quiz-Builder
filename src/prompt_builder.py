def build_quiz_prompt(topic: str, role: str, num_questions: int, difficulty: str, language: str) -> str:
    """
    Susun instruksi lengkap untuk Gemini berdasarkan input user.
    Bentuk JSON TIDAK dijelaskan di sini secara manual - itu diatur
    terpisah lewat response_schema di gemini_client.py.
    """
    return f"""Anda adalah pembuat soal quiz internal untuk karyawan 99 Group, perusahaan properti.
